...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-opg-37388-atomicity-of-the-poset-of-multifuncoid-29970d87",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-37388-19bccb3aa6cc",
        "url": "https://www.unsolvedmath.com/problems/OPG-37388"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Conjecture The poset of multifuncoids of the form $(\\mathscr{P}\\mho)^n$ is for every sets $\\mho$ and $n$: - atomic; - atomistic. See below for definition of all concepts and symbols used to in this conjecture. Refer to this Web site for the theory which I now attempt to generalize.",
      "version": 1
    },
    "title": "Atomicity of the poset of multifuncoids",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "985fd7b3f4da80982cc356e43eff809af6d05a365f165569bf90892fa68b4caf"
}
```
